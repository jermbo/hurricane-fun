...
const { default: db } = require("./gulp/db");
...
exports.default = series(cleanAll, parallel(html, redirects, db, styles, scripts, images), cleanTmp, serve, watcher);
exports.build = series(cleanAll, parallel(html, redirects, db, styles, scripts, images), cleanTmp);
